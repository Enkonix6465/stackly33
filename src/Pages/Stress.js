...
import video from '../assets/Services5.mp4'; // Replace with a stress-relief video if available
import { useNavigate } from "react-router-dom";
import stressImage from "../assets/SR.jpg"; // Replace with a stress-related image
    ...
    <div className={themedClass(
      ...
      <section className="w-full px-6 py-16 flex flex-col md:flex-row items-start gap-10">
        <div className="flex-1">
          ...
          <p className={themedClass(
            ...
            Proven techniques to manage stress, enhance emotional resilience, and maintain mental clarity. 
            Learn mindful practices to stay calm under pressure.
          </p>
      ...
      <section className={themedClass(
        ...
        <h2 className={themedClass(
          ...
          Our Stress Resilience Services
        </h2>
        <p className={themedClass(
          "mb-10",
          "text-green-100",
          ...
          Techniques and routines to help you reduce stress, stay calm, and strengthen mental resilience.
        </p>
        ...
        <div className={themedClass(
          ...
          <div>
            ...
            <p className={themedClass(
              ...
              Reduce anxiety and maintain mental clarity throughout the day.
            </p>
          </div>
          <div>
            <h3 className={themedClass(
              ...
              "text-green-200",
              "text-green-700"
            )}>💪 Emotional Resilience</h3>
            <p className={themedClass(
              "",
              "text-green-100",
              "text-gray-700"
            )}>
              Strengthen your ability to cope with stress and challenges.
            </p>
          </div>
          <div>
            <h3 className={themedClass(
            ...
            <p className={themedClass(
              ...
              Support mental, emotional, and physical health daily.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className={themedClass(
        ...
        <p className={themedClass(
          ...
          Choose a program to manage stress, strengthen resilience, and improve overall wellbeing.
        </p>
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-2xl px-4">
          ...
          <p className="text-white/90 mb-6">
            Start your journey to calm, clarity, and stronger emotional resilience today.
          </p>
          <button
            onClick={() => handleGetStarted("/contact")}
            className={themedClass(
